...
#include "C:\Users\anees\CLionProjects\RUbiks\Solver\IDDFSSolver.h"
...
//    checking of IDDFSSolver
    RubiksCube3darray cube;
    cube.print();

    vector<genericRubiksCube::MOVE> shuffle_moves = cube.randomShuffleColor(5);
...
//
//    checking for BFSSolver
//
//    RubiksCube3darray cube;
//    cube.print();
//
//    vector<genericRubiksCube::MOVE> shuffle_moves = cube.randomShuffleColor(6);
//    for (auto move: shuffle_moves) cout << cube.getMove(move) << " ";
//    cout << "\n";
//    cube.print();
//
